    ...
    <aside style={{ background: "#d7c99e", color: "#28261f" }}>
      ...
      >
        ...
        >
          ...
          >
            Courbet macht Material, Anstrengung und monumentale Gegenwart sichtbar.
            Millet verschiebt den Fokus auf zyklische Arbeit, soziale Zugangsrechte und
            Körper, deren Abhängigkeit gerade durch ihre Größe nicht verschwindet.
          </p>
        </div>

        <ArtworkStrip
          items={milletAxisArtworks}
          title="Saat, Restarbeit und gezeichnete Körper"
        />
