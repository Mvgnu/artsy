  ...
  return (
    <main style={{ background: "#efe8d7", color: "#27271f" }}>
      ...
      >
        ...
        >
          Millet machte ländliche Arbeit groß, langsam und unausweichlich sichtbar.
          Seine Bauern sind weder Staffage noch einfache Helden: Sie stehen zwischen
          körperlicher Würde, ökonomischer Abhängigkeit und späterer nostalgischer
          Vereinnahmung.
        </p>
      </section>
      ...
      >
        <div style={{ margin: "0 auto", maxWidth: "92rem" }}>
          <ArtworkStrip
            items={milletProfileArtworks}
            title="Saat, Restarbeit, Gebet und Erschöpfung"
          />
        </div>
      </section>
        ...
        >
          {phases.map((phase, index) => (
            <article
              key={phase.title}
              style={{
                borderTop: "1px solid rgb(39 39 31 / .35)",
                minHeight: "22rem",
                padding: "1.5rem 0",
              }}
            >
      ...
      <section
        style={{ background: "#c8b67e", padding: "clamp(5rem, 10vw, 8rem) 1.25rem" }}
      >
        <div style={{ margin: "0 auto", maxWidth: "78rem" }}>
          ...
          >
            Seine Bilder zeigen Tätigkeiten, deren soziale Bedeutung historisch konkret
            ist: Zugang zu Land, Rechte auf Erntereste, Abhängigkeit von Jahreszeiten
            und die Frage, welche Arbeit als würdig, bedrohlich oder malerisch
        ...
        >
          {links.map(([eyebrow, href, title]) => (
            <Link
              ...
              href={href!}
              style={{
                border: "1px solid rgb(39 39 31 / .3)",
                color: "inherit",
                minHeight: "13rem",
                padding: "1.5rem",
                textDecoration: "none",
