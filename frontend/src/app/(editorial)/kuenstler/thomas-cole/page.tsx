    ...
    >
      ...
      >
        ...
        >
          ...
          <p style={{ maxWidth: "34rem", fontSize: "1.25rem", lineHeight: 1.75 }}>
            Cole malte Landschaft nicht als leere Natur. Er machte sie zum Ort, an dem
            eine junge Nation über Fortschritt, Eigentum, Erinnerung und ihre eigene
            Zukunft nachdachte.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "1.17rem", lineHeight: 1.85 }}>
            Seine Bilder entstanden in einer Zeit territorialer Expansion,
            beschleunigter Besiedlung und wirtschaftlicher Umformung. Wenn Cole Wildnis
            und kultiviertes Land gegenüberstellt, malt er deshalb nicht nur
            Naturzustände. Er malt konkurrierende Vorstellungen davon, was Amerika sein
            sollte.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#c9b78e" }}>
        ...
        >
          <p style={{ color: "#5e3825", fontWeight: 800, letterSpacing: ".18em" }}>
            LEBEN UND ARBEIT
          </p>
          <div
            style={{
          ...
          >
            {phases.map((phase) => (
              <section
                ...
                style={{
                  display: "grid",
                  gridTemplateColumns: "minmax(7rem, .25fr) 1fr",
                  gap: "2rem",
                  padding: "2rem",
                  background: "#d9caa8",
                }}
      ...
      >
        ...
        >
          {strategies.map((strategy, index) => (
            <article
              key={strategy.title}
              style={{ padding: "2rem", border: "1px solid rgb(23 33 30 / .2)" }}
            >
      ...
      <section style={{ background: "#17211e", color: "#f3ecdc" }}>
        ...
        >
          ...
          >
            <p
              style={{
                color: "rgb(243 236 220 / .78)",
                fontSize: "1.08rem",
                lineHeight: 1.85,
              }}
            >
              Coles Sorge um zerstörte Natur ist real. Gleichzeitig beruhte die
              Vorstellung unberührter amerikanischer Wildnis häufig darauf, indigene
              Präsenz, Nutzung und Vertreibung unsichtbar zu machen. Ein kritischer
              Blick muss beide Ebenen zusammenhalten.
            </p>
            <p
              style={{
                color: "rgb(243 236 220 / .78)",
            ...
            >
              Deshalb ist Cole weder bloß Naturschützer noch bloß Ideologe der
              Expansion. Seine Gemälde zeigen eine Gesellschaft, die ihre Widersprüche
              in Landschaft projiziert – und gerade dadurch mehr verrät, als eine
              eindeutige Botschaft es könnte.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          <Link href="/werke/the-oxbow-thomas-cole/">
            The Oxbow Schritt für Schritt lesen →
          </Link>
