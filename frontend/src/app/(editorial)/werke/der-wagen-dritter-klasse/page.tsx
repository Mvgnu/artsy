  ...
  return (
    <main style={{ background: "#d7cec0", color: "#252622" }}>
      ...
      >
        ...
        >
          Menschen sitzen dicht nebeneinander und bleiben dennoch sozial getrennt.
          Daumier macht Eisenbahnverkehr als Klassenraum sichtbar: als geteilte
          Infrastruktur mit ungleich verteiltem Komfort, Blick und Bewegungsraum.
        </p>
      </section>
      ...
      >
        <div style={{ margin: "0 auto", maxWidth: "92rem" }}>
          <ArtworkStrip
            items={thirdClassContextArtworks}
            title="Wagenklasse, urbane Last und industrielle Nähe"
          />
        </div>
      </section>
        ...
        >
          {readings.map(([title, text], index) => (
            <article
              key={title}
              style={{
                borderTop: "1px solid rgb(37 38 34 / .35)",
                minHeight: "21rem",
                padding: "1.5rem 0",
              }}
            >
      ...
      >
        <div style={{ margin: "0 auto", maxWidth: "78rem" }}>
          ...
          >
            Mobilität kann soziale Unterschiede gleichzeitig verbinden und
            festschreiben.
          </h2>
          <p
            style={{
          ...
          >
            Die Eisenbahn erweitert Reichweite und Geschwindigkeit. Doch der Wagen
            zeigt, dass technische Modernisierung nicht für alle denselben
            Körperkomfort, dieselbe Privatheit oder dieselbe gesellschaftliche
            Sichtbarkeit produziert.
          </p>
        </div>
      </section>
        ...
        >
          {links.map(([eyebrow, href, title]) => (
            <Link
              ...
              href={href!}
              style={{
                border: "1px solid rgb(37 38 34 / .3)",
                color: "inherit",
                minHeight: "13rem",
                padding: "1.5rem",
                textDecoration: "none",
