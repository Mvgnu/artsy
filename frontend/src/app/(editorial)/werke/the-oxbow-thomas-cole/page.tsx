...
export default function OxbowPage() {
  return (
    <article style={{ background: "#e9e1cf", color: "#18211e", minHeight: "100vh" }}>
      <header
        style={{ padding: "clamp(5rem, 10vw, 8rem) 1.25rem 3rem", textAlign: "center" }}
      >
        ...
        >
          Ein berühmtes Landschaftsbild, das nicht zwischen Natur und Zivilisation
          entscheidet, sondern zeigt, wie sehr diese Begriffe politisch gemacht sind.
        </p>
      </header>

      <figure style={{ width: "min(94rem, calc(100% - 2rem))", margin: "0 auto" }}>
        <div
          style={{ position: "relative", aspectRatio: "1.475", background: "#111816" }}
        >
          <Image
            alt={artwork.alt}
            fill
        ...
        <figcaption style={{ marginTop: "1rem", fontSize: ".82rem", lineHeight: 1.6 }}>
          <em>{artwork.shortTitle}</em>, {artwork.artist}, {artwork.date}.{" "}
          {artwork.medium}, {artwork.dimensions}. {artwork.institution}.{" "}
          {artwork.credit}.{" "}
          <a href={artwork.sourceUrl}>Public Domain · Werkdatensatz</a>
        </figcaption>
      </figure>
      ...
      >
        ...
        >
          <p style={{ fontSize: "1.15rem", lineHeight: 1.85 }}>
            Der Blick fällt von Mount Holyoke auf die große Schleife des Connecticut
            River. Links ist die Natur nah, dunkel und körperlich. Rechts wird sie fern,
            übersichtlich und in Felder gegliedert. Cole baut damit keine einfache
            Vorher-nachher-Erzählung, sondern einen Konflikt in Echtzeit.
          </p>
          <p style={{ fontSize: "1.15rem", lineHeight: 1.85 }}>
            Die Bildhälften sind voneinander abhängig. Ohne die dunkle Linke erschiene
            die rechte Ordnung weniger hell; ohne die rechte Ebene wäre die Wildnis
            links nur dramatische Natur. Erst der Vergleich macht beide zu politischen
            Kategorien.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#17211e", color: "#f1ead9" }}>
        ...
        >
          <p style={{ color: "#d5ae68", fontWeight: 800, letterSpacing: ".18em" }}>
            VIER BILDENTSCHEIDUNGEN
          </p>
          <div
            style={{
              display: "grid",
              ...
              gap: "1px",
              marginTop: "3rem",
              background: "rgb(241 234 217 / .18)",
            }}
          >
            {observations.map((observation) => (
              <article
                key={observation.number}
                style={{ padding: "2rem", background: "#17211e" }}
              >
                <span style={{ color: "#d5ae68", fontWeight: 800 }}>
                  {observation.number}
                </span>
                <h3
                  style={{
      ...
      >
        ...
        >
          <p style={{ fontSize: "1.1rem", lineHeight: 1.85 }}>
            Der erhöhte Standort erlaubt es, das Tal als Ganzes zu sehen. Diese
            Übersicht macht Landschaft lesbar: Felder, Wege, Wasser und Wald werden zu
            einem System. Genau darin liegt auch eine Form von Macht. Was aus der Nähe
            komplex und bewohnt ist, kann aus der Distanz als Fläche erscheinen.
          </p>
          <p style={{ fontSize: "1.1rem", lineHeight: 1.85 }}>
            Coles winzige Selbstfigur stört diese Souveränität. Der Maler sitzt nicht
            außerhalb der Szene. Er ist körperlich im unwegsamen Vordergrund verankert
            und muss seinen Überblick erst konstruieren. Das Bild zeigt damit zugleich
            die Verlockung und die Fragwürdigkeit des panoramatischen Blicks.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#cbb98f" }}>
        ...
        >
          <p style={{ color: "#5e3926", fontWeight: 800, letterSpacing: ".18em" }}>
            VIER LESARTEN
          </p>
          <div
            style={{
          ...
          >
            {readings.map((reading) => (
              <article
                ...
                style={{
                  padding: "2rem",
                  border: "1px solid rgb(24 33 30 / .2)",
                  background: "rgb(233 225 207 / .42)",
                }}
              >
                <h3
                  style={{
      ...
      >
        ...
        <p style={{ maxWidth: "48rem", fontSize: "1.15rem", lineHeight: 1.9 }}>
          Das Bild macht menschliche Nutzung rechts sichtbar und lässt sie links fast
          verschwinden. Eine heutige Betrachtung sollte deshalb fragen, wessen
          Geschichte in der Kategorie Wildnis fehlt. Die Landschaft war nicht leer; sie
          wurde durch nationale Bildkultur häufig als leer erzählt. Diese Leerstelle
          ändert nicht die formale Kraft des Gemäldes, aber sie verändert, was sein
          Gegensatz von Natur und Zivilisation bedeutet.
        </p>
      </section>
