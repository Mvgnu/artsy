...
const distinctions = [
  [
    "Arbeit ist nicht Landschaftsstaffage",
    "Ländliche Figuren erklären nicht nur Maßstab oder Jahreszeit. Ihre Tätigkeiten strukturieren Raum, Rhythmus, Körperhaltung und die Verteilung von Ressourcen.",
  ],
  [
    "Sichtbarkeit ist nicht automatisch Würde",
    "Ein groß dargestellter Körper kann weiterhin anonym, abhängig und sozial marginal bleiben. Monumentalität muss deshalb zusammen mit Haltung, Blickzugang und Handlungsspielraum gelesen werden.",
  ],
  [
    "Idealisiert heißt nicht unwahr",
    "Abendlicht, klare Rhythmen oder harmonische Gruppierung können Arbeit versöhnen, ohne ihre sozialen Bedingungen vollständig zu leugnen. Entscheidend ist, was diese ästhetische Ordnung sichtbar macht und was sie beruhigt.",
  ],
  [
    "Materialität ist sozial organisiert",
    "Boden, Saat, Ernte, Werkzeuge und Wetter sind physische Bedingungen. Wer Zugang zu Land, Resten, Zeit oder Geräten hat, ist jedoch historisch und rechtlich geregelt.",
  ],
] as const;
...
const links = [
  ...
  [
    "Grundbegriff",
    "/begriffe/arbeit-und-materiale-realitaet/",
  ...
  return (
    <main style={{ background: "#eee6d5", color: "#27261f" }}>
      ...
      >
        ...
        >
          Realistische Bauernbilder zeigen nicht einfach „das einfache Leben“. Sie
          ordnen Körper, Boden, Eigentum, Ertrag und Blickbarkeit. Die entscheidende
          Frage lautet nicht nur, wer arbeitet, sondern unter welchen Bedingungen diese
          Arbeit sichtbar werden darf.
        </p>
      </section>
      ...
      >
        <div style={{ margin: "0 auto", maxWidth: "92rem" }}>
          <ArtworkStrip
            ...
            title="Restarbeit, Erschöpfung, Ideal und Industrie"
          />
        </div>
      </section>
        ...
        >
          {distinctions.map(([title, text], index) => (
            <article
              key={title}
              style={{
                borderTop: "1px solid rgb(39 38 31 / .35)",
                minHeight: "20rem",
                padding: "1.5rem 0",
              }}
            >
      ...
      <section
        style={{ background: "#c8b77e", padding: "clamp(5rem, 10vw, 8rem) 1.25rem" }}
      >
        <div style={{ margin: "0 auto", maxWidth: "78rem" }}>
          ...
          >
            Sechs Fragen an Bilder der Arbeit
          </h2>
          <ol
            style={{
              display: "grid",
        ...
        >
          {links.map(([eyebrow, href, title]) => (
            <Link
              ...
              href={href!}
              style={{
                border: "1px solid rgb(39 38 31 / .3)",
                color: "inherit",
                minHeight: "13rem",
                padding: "1.5rem",
                textDecoration: "none",
